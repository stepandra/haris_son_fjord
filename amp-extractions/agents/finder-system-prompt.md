# Finder / Search Subagent System Prompt - Amp CLI v0.0.1777185893-gae6d40

**Source:** `npm-packages/0.0.1777185893-gae6d40/node_modules/@sourcegraph/amp/dist/main.js`
**Agent Key:** `finder`
**Display Name:** Finder / Search
**Model:** `CLAUDE_HAIKU_4_5` in the bundle registry; the public models page describes Search as fast codebase retrieval.
**Tools:** `Grep`, `glob`, `Read`
**Prompt Function:** `aF5(A,Q)` line `3284`

## Full Finder System Prompt

Interpolation notes: `${A}` is the working directory; `${Q}` is the workspace root.
...
## Environment
Working directory: ${A??"unknown"}
Workspace root: ${Q??"unknown"}
