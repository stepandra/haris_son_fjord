# Oracle Agent System Prompt - Amp CLI v0.0.1777185893-gae6d40

**Source:** `npm-packages/0.0.1777185893-gae6d40/node_modules/@sourcegraph/amp/dist/main.js`
**Agent Type:** Senior engineering advisor subagent
**Prompt Function:** `Je0(A,Q)`
**Prompt Line:** `4106`

## Full Oracle System Prompt

Interpolation notes: `${A}` is the current working directory when present; `${Q}` is the workspace root when present.
